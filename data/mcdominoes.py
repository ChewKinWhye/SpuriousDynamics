...
class MCDOMINOES(Dataset):
    def __init__(self, x, y, p, isTrain, target_resolution=(64, 32)):
        self.x = x
        self.y_array = y
        self.p_array = p
...
def get_mcdominoes(spurious_strength, data_dir, seed):
    VAL_SIZE = 5000
    save_dir = os.path.join(data_dir, f"mcdominoes_{spurious_strength}-{seed}.pkl")
